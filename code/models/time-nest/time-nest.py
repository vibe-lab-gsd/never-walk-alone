# Model with independence-based nest
...
low_time_nest = OneNestForNestedLogit(
    nest_param=mu_low_time,
    list_of_alternatives=[1,3],
    name='low_time_nest'
)

time_nests = NestsForNestedLogit(
    choice_set=list(V),
    tuple_of_nests=(low_time_nest,)
)

# Define model
my_model = models.lognested(V, av, time_nests, mode_ind)

# Create biogeme object
the_biogeme = bio.BIOGEME(database_est, my_model)
the_biogeme.modelName = 'time_nests'
