...
The 2022 dataset does not include a density variable, so we're creating one
...
* Trip was a reasonable walking distance (less than 1 mile)
...
mode_short_summary <- school_trips |>
  filter(TRPMILES > 0) |>
  mutate(short = ifelse(TRPMILES < 1, "short", "long")) |>
  ...
  mutate(`Percent of school trips shorter than 1 mile (2009)` = 
           paste0(`short2009`, "%"),
         `Percent of school trips shorter than 1 mile (2017)` = 
           paste0(`short2017`, "%"),
         `Percent of school trips shorter than 1 mile (2022)` = 
           paste0(`short2022`, "%"),
         `Percent of school trips longer than 1 mile (2009)` = 
           paste0(`long2009`, "%"),
         `Percent of school trips longer than 1 mile (2017)` = 
           paste0(`long2017`, "%"),
         `Percent of school trips longer than 1 mile (2022)` = 
           paste0(`long2022`, "%")) |>
  select(mode,
         `Percent of school trips shorter than 1 mile (2009)`,
         `Percent of school trips shorter than 1 mile (2017)`,
         `Percent of school trips shorter than 1 mile (2022)`,
         `Percent of school trips longer than 1 mile (2009)`,
         `Percent of school trips longer than 1 mile (2017)`,
...
## Sample size of trips shorter than 1 mile
...
short_sample <- bind_rows(short_hh_summary,
                          short_trip_summary) |>
  mutate(Sample = "Limit to trips shorter than 1 mile") |>
  group_by(year) |>
